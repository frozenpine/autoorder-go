...
var fileDescriptor_2bc2336598a3f7e0 = []byte{
	...
	0xc9, 0x4f, 0xce, 0xcf, 0xd1, 0x03, 0x33, 0x84, 0x38, 0x60, 0x7c, 0x25, 0x25, 0x2e, 0x1e, 0x8f,
	...
	0x08, 0xc6, 0x35, 0x72, 0xe6, 0x62, 0x75, 0x2f, 0x4a, 0x4d, 0x2d, 0x11, 0xb2, 0xe2, 0xe2, 0x08,
	0x4e, 0xac, 0x04, 0xeb, 0x11, 0x12, 0xd3, 0x83, 0xdb, 0x8d, 0x6c, 0x91, 0x94, 0x08, 0x86, 0x78,
	0x41, 0x4e, 0xa5, 0x12, 0x83, 0x13, 0xdb, 0x22, 0x26, 0xe6, 0x90, 0xe0, 0x90, 0x24, 0x36, 0xb0,
	0xb4, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0xaf, 0x1f, 0xe7, 0x57, 0xbb, 0x00, 0x00, 0x00,
}
...
func (c *greetClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/protocol.Greet/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Greet_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protocol.Greet/SayHello",
	}
